...
if __name__ == '__main__':
    ...
    chuncks = pd.read_csv(path_filename, delimiter='|' , dtype={"loc_name": str, "admit_dep_name":str ,"department_id":object ,"hospital_service":str}, names = columns, skiprows = 1000000, parse_dates=['birth_date','contact_date', 'ord_result_time','order_time','hosp_disch_time','inpatient_adm_date','hosp_adm_time','death_date'], chunksize=100000)
